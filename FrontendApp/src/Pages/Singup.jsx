...
const Singup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#080710] px-4 sm:px-6 lg:px-8">
      <div className="relative w-full max-w-md">
        <form
          onSubmit={handleSubmit}
          className="relative z-10 backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl text-white rounded-lg p-6 sm:p-8 md:p-10 w-full"
        >
          ...
          <p className="text-center mt-4 text-white text-sm">
            ...
            <Link
              to="/login"
              className="underline text-white hover:text-gray-300 block mt-1"
            >
              Login here...
            </Link>
          </p>
